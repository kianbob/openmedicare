...
export const metadata: Metadata = {
  ...
  description: '$1.05T+ in Medicare payments (2014-2023). 1.82M providers scanned by AI. 500 flagged for fraud. Upcoding, COVID test schemes, wound care fraud, and impossible billing exposed — serving 68.5M beneficiaries.',
  alternates: { canonical: '/fraud' },
  openGraph: {
    title: 'AI Flagged 500 Medicare Providers for Fraud',
    description: '$1.05T+ in Medicare payments (2014-2023). 1.82M providers scanned by AI. 500 flagged for fraud. Upcoding, COVID schemes, wound care fraud exposed — updated 2026.',
...
const jsonLd = [
  ...
  },
  {
    ...
    description: 'CMS Medicare physician payment data from 2014-2023, covering $1.05 trillion in spending across 1.2 million providers',
    url: 'https://www.openmedicare.us/fraud',
