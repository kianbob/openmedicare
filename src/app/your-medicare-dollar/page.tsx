      ...
      <div className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        ...
        <div className="mt-8">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-3xl">
            ...
            Based on {formatCurrency(stats.total_payments)} in total Medicare Part B payments (2014–2025).
          </p>
        </div>
        ...
        <div className="mt-16 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 p-8 text-white text-center">
          ...
          <p className="mt-4 text-xs opacity-60">Source: OpenMedicare analysis of CMS data (2014–2025)</p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="rounded-xl bg-gray-50 p-6 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">Years of Data (2014–2025)</p>
          </div>
        </div>

        <div className="mt-12">
          <ShareButtons
            url="https://www.openmedicare.us/your-medicare-dollar"
