...
const sections = [
  {
    ...
    href: '/about',
    description: 'OpenMedicare analyzes 1.7 million providers across $854.8B in Medicare payments, with 2,938 deep-profiled. 500 are ML-flagged for fraud risk.',
    icon: '👋',
  ...
  },
  {
    ...
    href: '/lookup',
    description: 'Search any of 1.7M Medicare providers — 2,938 have detailed profiles with billing history, specialty comparison, and risk flags.',
    icon: '🔍',
