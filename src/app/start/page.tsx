...
const sections = [
  {
    ...
    href: '/about',
    description: 'OpenMedicare analyzes 1.7 million providers across $854.8B in Medicare payments, with 30,000+ deep-profiled. 500 are ML-flagged for fraud risk.',
    icon: '👋',
  ...
  },
  {
    ...
    href: '/investigations',
    description: '65 data-driven investigations exploring Medicare spending patterns, from drug money to geographic inequality.',
    icon: '📰',
