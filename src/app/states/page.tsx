...
const stateFaqs = [
  { question: 'Which state has the highest Medicare spending?', answer: 'California, Florida, Texas, and New York consistently rank as the top Medicare spending states, driven by large elderly populations and high provider counts. Our interactive map shows total payments by state from 2014-2025.' },
    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">Explore Medicare provider payments across all 50 states and territories. Data covers 2014-2025.</p>
        </div>
