      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {data.yearly_trends && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <TrendChart data={data.yearly_trends.map((y: any) => ({ year: y.year, value: y.drug_share_percentage || 0 }))} label="Drug Share %" suffix="%" />
          </div>
        )}
        ...
        {data.yearly_trends && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <TrendChart data={data.yearly_trends.map((y: any) => ({ year: y.year, value: y.drug_payments || 0 }))} label="Drug Payments" prefix="$" />
          </div>
        )}
