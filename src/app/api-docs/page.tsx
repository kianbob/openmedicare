      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <p className="text-sm text-gray-500 mt-3">
            Also available at <code className="bg-gray-100 px-1 py-0.5 rounded text-xs">https://openmedicare.vercel.app/data/</code>
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <div className="space-y-4 text-sm text-gray-700">
            ...
            <div>
              ...
              <p>Please credit <strong>OpenMedicare</strong> and link to <code className="bg-gray-100 px-1 py-0.5 rounded text-xs">openmedicare.vercel.app</code> when using our data.</p>
            </div>
            <div>
