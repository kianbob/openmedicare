...
export const metadata: Metadata = {
  title: 'Medicare Data API — 20+ Free Endpoints',
  description: 'Access 105M+ Medicare claims via free JSON endpoints. No API key needed. Fraud scores, spending trends, provider lookups — ready for any language.',
}
...
const endpoints = [
  ...
  { path: '/data/trends.json', description: '10-year spending trends (2014–2025)' },
...
console.log(data.providers.length) // 500 flagged providers`}</pre>
  ...
  "last_updated": "2026-02-21"
          ...
          <div className="mt-4 text-sm text-gray-600 space-y-1">
            ...
            <p><code className="bg-gray-100 px-1 py-0.5 rounded text-xs">total_payments</code> — Total Medicare payments in dollars (2014–2025)</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          ...
          <div className="space-y-4 text-sm text-gray-700">
            ...
            <div>
              ...
              <p>Original data from <a href="https://data.cms.gov" target="_blank" rel="noopener noreferrer" className="text-medicare-primary hover:underline">CMS (Centers for Medicare & Medicaid Services)</a>. Medicare Provider Utilization and Payment Data, 2014–2025.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 mb-1">Update Frequency</h3>
              <p>Datasets are refreshed periodically as CMS publishes new annual releases. Current data covers 2014–2025 (the latest available release).</p>
            </div>
          </div>
        </div>
