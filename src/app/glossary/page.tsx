...
const glossaryTerms = ([
  ...
  { term: 'Provider Profile', definition: 'An aggregated view of a provider\'s billing history, including total payments received, services rendered, beneficiaries served, specialty, location, and fraud risk indicators across all available years (2014–2024).', category: 'data', related: ['NPI', 'Specialty'] },
