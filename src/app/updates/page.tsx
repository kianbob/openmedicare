...
export const metadata: Metadata = {
  ...
  description: 'See every new feature, data release, and investigation as it ships. AI fraud detection, 64+ articles, and 2,938 provider profiles — all tracked here.',
  alternates: {
    canonical: '/updates',
  },
}
    ...
    items: [
      {
        ...
        description: 'Added investigation disclaimers, unified provider database (2,938 providers), ML fraud model integration (500 AI-flagged providers), dynamic OG images, 65 investigation articles.',
