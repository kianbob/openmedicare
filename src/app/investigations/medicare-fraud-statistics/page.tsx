...
export const metadata: Metadata = {
  ...
  description: 'Medicare fraud costs taxpayers $60–100 billion annually from $1.05T in total payments. See the latest fraud statistics, enforcement data, and AI findings.',
