          ...
          <div className="p-8 lg:p-12">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 mb-4">
                Between 2014 and 2023, Medicare Part B paid $1.05 trillion to 1.72 million unique providers — physicians, nurse practitioners, clinical laboratories, and medical suppliers. That&apos;s public money, paid with taxpayer dollars and beneficiary premiums, and every cent is tracked in CMS data.
              </p>
              <p className="text-gray-700 mb-4">
