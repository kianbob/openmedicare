        ...
        <article className="bg-white rounded-lg shadow-sm overflow-hidden">
          <div className="p-8 lg:p-12">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-700 mb-4">
                <strong>Traditional Medicare (Fee-for-Service):</strong> CMS pays providers directly for each service. A doctor bills for an office visit, a lab bills for a blood test, and CMS pays each claim individually. This is the data OpenMedicare tracks — 105 million+ claims over 10 years.
              </p>
              <p className="text-gray-700 mb-4">
              ...
              <p className="text-gray-700 mb-4">
                This means that as more beneficiaries shift to MA, the Traditional Medicare dataset we analyze represents a shrinking share of total Medicare spending. Our 1.82 million providers and $1.05 trillion in payments reflect Part B fee-for-service billing only.
              </p>
              <p className="text-gray-700 mb-4">
            ...
            <RelatedArticles articles={[
              ...
              { slug: 'medicare-spending-trends-2025', title: 'Medicare Spending Trends 2025', description: 'Where $1.05 trillion in Medicare spending actually goes.' },
