...
const providerFaqs = [
  ...
  { question: 'What data does OpenMedicare use for provider payments?', answer: 'OpenMedicare uses CMS Medicare Provider Utilization and Payment Data from 2014-2025, covering over $1.05 trillion in total payments to 1.82 million providers.' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">
            Explore {formatNumber(providers.length)} healthcare providers and their Medicare payments from 2014-2025. Our dataset covers 1.82M providers and $1.05T in total payments — these are the providers we&apos;ve profiled in detail. Includes all watchlisted and AI-flagged providers.
          </p>
        </div>
